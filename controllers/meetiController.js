...
exports.editarMeeti = async (req, res, next) => {
    ...
    //asignar los valores
    const {grupoId, titulo, invitado, fecha , hora, cupo, descripcion, ciudad, estado , pais, lat, lng} = req.body;
...
//muestra un formulario para elimianr meetis
...
exports.eliminarMeeti = async (req, res) => {
    ...
    req.flash('exito', 'Meeti Elimiando');
    res.redirect('/administracion');
}